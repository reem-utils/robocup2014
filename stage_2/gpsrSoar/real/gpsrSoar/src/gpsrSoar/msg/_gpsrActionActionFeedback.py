"""autogenerated by genpy from gpsrSoar/gpsrActionActionFeedback.msg. Do not edit."""
import sys
...
class gpsrActionActionFeedback(genpy.Message):
  _md5sum = "e4a7fa5a2668673ce0c9f0d0d771d3ad"
  _type = "gpsrSoar/gpsrActionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gpsrSoar/gpsrActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gpsrActionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = gpsrSoar.msg.gpsrActionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = gpsrSoar.msg.gpsrActionFeedback()
