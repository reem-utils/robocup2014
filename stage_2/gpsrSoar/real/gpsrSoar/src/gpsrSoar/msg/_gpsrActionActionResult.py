"""autogenerated by genpy from gpsrSoar/gpsrActionActionResult.msg. Do not edit."""
import sys
...
class gpsrActionActionResult(genpy.Message):
  _md5sum = "76e505f84da88685989704705a0d9846"
  _type = "gpsrSoar/gpsrActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gpsrSoar/gpsrActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gpsrActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = gpsrSoar.msg.gpsrActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gpsrSoar.msg.gpsrActionResult()
