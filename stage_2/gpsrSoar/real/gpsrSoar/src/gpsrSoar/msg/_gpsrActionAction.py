"""autogenerated by genpy from gpsrSoar/gpsrActionAction.msg. Do not edit."""
import sys
...
class gpsrActionAction(genpy.Message):
  _md5sum = "5bb9b72ee77a378288b662aa160ce69c"
  _type = "gpsrSoar/gpsrActionAction"
...
"""
  ...
  _slot_types = ['gpsrSoar/gpsrActionActionGoal','gpsrSoar/gpsrActionActionResult','gpsrSoar/gpsrActionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gpsrActionAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = gpsrSoar.msg.gpsrActionActionGoal()
      if self.action_result is None:
        self.action_result = gpsrSoar.msg.gpsrActionActionResult()
      if self.action_feedback is None:
        self.action_feedback = gpsrSoar.msg.gpsrActionActionFeedback()
    else:
      self.action_goal = gpsrSoar.msg.gpsrActionActionGoal()
      self.action_result = gpsrSoar.msg.gpsrActionActionResult()
      self.action_feedback = gpsrSoar.msg.gpsrActionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.orderList)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.orderList:
        _x = val1.action
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.orderList = []
      for i in range(0, length):
        ...
        self.action_goal.goal.orderList.append(val1)
      _x = self
      start = end
      end += 12
