    ...
    def execute(self, userdata):
        ...
        if userdata.loop_iterations == NUMBER_OF_HEAD_POSES:
            ...
            if userdata.loop_iterations == 0:
                userdata.head_left_right = 'total_left'
            ...
            elif userdata.loop_iterations == 3:
                userdata.head_left_right = 'total_right'
            elif userdata.loop_iterations == 4:
    ...
    def __init__(self, head_position=None):
        ...
        with self:
            ...
            smach.StateMachine.add(
                                   ...
                                   transitions={'succeeded': 'wave_recognition',
