...
class GetPoseSubscribe(smach.State):
    ...
    def execute(self, userdata):
        try:
            pose_current = rospy.wait_for_message('/slam_karto_pose', PoseWithCovarianceStamped, 10)
            ...
            userdata.standard_error = "get_current_robot_pose : Time_out getting /slam_karto_pose"
            return 'aborted'
            

class get_current_robot_pose_mapping(smach.StateMachine):
    """
